...
func (c *Client) GetObjectString(
	ctx context.Context,
	objID bfcObjectID,
	options *types.BfcObjectDataOptions,
) (string, error) {
	var resp types.BfcObjectResponse
	return c.CallContextString(ctx, &resp, getObject, objID, options)
}
...
func (c *Client) GetInnerDaoInfoObject(
	ctx context.Context,
) (*types.BfcDaoInfoResponse, error) {
	var resp types.BfcDaoInfoResponse
	return &resp, c.CallContext(ctx, &resp, getInnerDaoInfo)
}
