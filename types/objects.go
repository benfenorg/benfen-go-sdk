...
type BfcStablePoolsResponse struct {
	responseData *BfcStablePoolsData `json:"responseData"`
}

type BfcStablePoolsDataWrapper struct {
	ObjectId string             `json:"objectId"`
	Content  BfcStablePoolsData `json:"content"`
}
type BfcStablePoolsData struct {
